<html lang="en"><head>
  ...
  *{
  ...
  <!--
  var tl=new Array("Click on the 'Get Started' button",
  "to see the hidden database",
  "of the world's largest companies",
  "& premium service for",
  "lifetime at a cheap price.")
  var speed=60;
  ...
  <center><form><textarea style="line-height: 23px; background-color: rgb(0, 0, 0); color: rgb(0, 255, 0); font-size: 16px; border: none; outline: none;" readonly="readonly" rows="5" cols="35" wrap="soft">_</textarea><br>
  </form>
  </center></center></div>
  <br><br>
  ...
  let countDownDate = new Date("Apr 13, 2024 23:59:59").getTime();
  ...
  <button class="ply" onclick="playAudio()" type="button"><i class="fa-solid fa-play" aria-hidden="true"></i></button>
  ...
  <div class="counter-up">
      <div class="content">
        ...
        <div class="box">
          <div class="icon"><i class="fa-solid fa-server" aria-hidden="true"></i></div>
